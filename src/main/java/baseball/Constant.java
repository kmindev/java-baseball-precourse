...
public class Constant {
    ...
    public static final String START_OR_END_INPUT_MESSAGE = "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.";
    ...
    public static final String ERROR_INVALID_START_OR_END = "1(재시작) 또는 2(종료)만 입력할 수 있습니다.";
